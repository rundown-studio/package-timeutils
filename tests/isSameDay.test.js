...
import { isSameDay } from '../dist/esm/index.js'

describe('isSameDay', () => {
  test('should return true for the same day in Berlin timezone (1)', () => {
    const date1 = new Date('2024-04-10T22:30:00Z') // 11th April 2024, 00:30 Berlin time
    const date2 = new Date('2024-04-10T23:30:00Z') // 11th April 2024, 01:30 Berlin time
    expect(isSameDay(date1, date2, { timezone: 'Europe/Berlin' })).to.be.true
  })

  test('should return true for the same day in Berlin timezone (2)', () => {
    const date1 = new Date('2024-04-10T22:00:00Z') // 11th April 2024, 00:00 Berlin time
    const date2 = new Date('2024-04-10T23:00:00Z') // 11th April 2024, 01:00 Berlin time
    expect(isSameDay(date1, date2, { timezone: 'Europe/Berlin' })).to.be.true
  })

  test('should return false for different days in Berlin timezone (1)', () => {
    const date1 = new Date('2024-04-10T22:00:00Z') // 11th April 2024, 00:00 Berlin time
    const date2 = new Date('2024-04-11T22:00:00Z') // 12th April 2024, 00:00 Berlin time
    expect(isSameDay(date1, date2, { timezone: 'Europe/Berlin' })).to.be.false
  })

  test('should return false for different days in Berlin timezone (2)', () => {
    const date1 = new Date('2024-04-10T21:30:00Z') // 10th April 2024, 23:30 Berlin time
    const date2 = new Date('2024-04-10T23:00:00Z') // 11th April 2024, 01:00 Berlin time
    expect(isSameDay(date1, date2, { timezone: 'Europe/Berlin' })).to.be.false
  })
  ...
  test('should return true for the same day in Los Angeles timezone', () => {
    ...
    expect(isSameDay(date1, date2, { timezone: 'America/Los_Angeles' })).to.be.true
  })
  ...
  test('should return false for different days in Los Angeles timezone', () => {
    ...
    expect(isSameDay(date1, date2, { timezone: 'America/Los_Angeles' })).to.be.false
  })
  ...
  test('should return true for the same day in Sydney timezone', () => {
    ...
    expect(isSameDay(date1, date2, { timezone: 'Australia/Sydney' })).to.be.true
  })
  ...
  test('should return false for different days in Sydney timezone', () => {
    ...
    expect(isSameDay(date1, date2, { timezone: 'Australia/Sydney' })).to.be.false
  })
  ...
  test('should return true for the same day in UTC', () => {
    ...
    expect(isSameDay(date1, date2, { timezone: 'UTC' })).to.be.true
  })

  test('should return false for different days in UTC', () => {
    const date1 = new Date('2024-04-10T00:00:00Z')
    const date2 = new Date('2024-04-11T00:00:00Z')
    expect(isSameDay(date1, date2, { timezone: 'UTC' })).to.be.false
  })
