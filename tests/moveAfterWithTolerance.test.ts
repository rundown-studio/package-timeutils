...
import { moveAfterWithTolerance } from '../src/index.js'

describe('moveAfterWithTolerance', () => {
  it('should throw an error if input is not a Date object', () => {
    expect(() => moveAfter('not a date', new Date())).toThrow()
    expect(() => moveAfter(new Date(), 'not a date')).toThrow()
    expect(() => moveAfter(new Date(), new Date(), 'not a number')).toThrow()
    expect(() => moveAfter(new Date(), new Date(), NaN)).toThrow()
  })
  ...
  it('should move the time to the same day when possible', () => {
    ...
    const after = new Date('2023-05-15T09:00:00Z')
    const result = moveAfterWithTolerance(time, after)
    expect(result).toEqual(new Date('2023-05-15T11:00:00Z'))
  })
  ...
  it('should move the time to the next day when outside 1h tolerance', () => {
    ...
    expect(result).toEqual(new Date('2023-05-16T20:50:00Z'))
  })
  ...
  it('should return the same time when within 1h tolerance', () => {
    ...
    const after = new Date('2023-05-15T22:00:00Z')
    const result = moveAfterWithTolerance(time, after, tolerance)
    expect(result).toEqual(new Date('2023-05-15T21:10:00Z'))
  })
  ...
  it('should handle dates across year boundaries', () => {
    ...
    const result = moveAfterWithTolerance(time, after)
    expect(result).toEqual(new Date('2024-01-01T23:00:00Z'))
  })
  ...
  it('should handle leap years correctly', () => {
    ...
    const result = moveAfterWithTolerance(time, after)
    expect(result).toEqual(new Date('2025-03-01T12:00:00Z'))
  })
  ...
  it('should handle daylight saving time transitions (America/New_York)', () => {
    ...
    expect(result).toEqual(new Date('2023-03-13T01:30:00-04:00'))
  })
  ...
  it('should handle very large tolerance values', () => {
    ...
    expect(result).toEqual(new Date('2023-05-15T12:00:00Z'))
  })
  ...
  it('should handle very small tolerance values, 1ms more', () => {
    ...
    expect(result).toEqual(new Date('2023-05-15T11:59:59.999Z'))
  })
  ...
  it('should handle very small tolerance, exact match', () => {
    ...
    const result = moveAfterWithTolerance(time, after, smallTolerance)
    expect(result).toEqual(new Date('2023-05-16T11:59:59.999Z'))
  })
  ...
  it('should handle zero tolerance', () => {
    ...
    const zeroTolerance = 0
    const result = moveAfterWithTolerance(time, after, zeroTolerance)
    expect(result).toEqual(new Date('2023-05-15T12:00:00.000Z'))
  })
  ...
  it('should handle negative tolerance', () => {
    ...
    expect(result).toEqual(new Date('2023-05-16T12:30:00Z'))
  })
  ...
  it('should handle Europe/Berlin DST start, inside tolerance', () => {
    ...
    expect(result).toEqual(new Date('2024-03-31T00:30:00Z')) // Sun Mar 31 2024 01:30:00 GMT+0100 (Central European Standard Time)
  })
  ...
  it('should handle Europe/Berlin DST end, outside tolerance', () => {
    ...
    const result = moveAfterWithTolerance(time, after, tolerance, { timezone })
    expect(result).toEqual(new Date('2023-10-30T01:30:00Z')) // Mon Oct 30 2023 02:30:00 GMT+0100 (Central European Standard Time)
  })
  ...
  it('should handle Australia/Sydney DST start, outside tolerance', () => {
    ...
    const result = moveAfterWithTolerance(time, after, tolerance, { timezone })
    expect(result).toEqual(new Date('2023-10-01T14:30:00Z')) // Mon Oct 02 2023 01:30:00 GMT+1100 (Australian Eastern Daylight Time)
  })
  ...
  it('should handle Australia/Sydney DST end, inside tolerance', () => {
    ...
    const result = moveAfterWithTolerance(time, after, tolerance, { timezone })
    expect(result).toEqual(new Date('2024-04-06T15:30:00Z')) // Sun Apr 07 2024 02:30:00 GMT+1100 (Australian Eastern Daylight Time)
  })
})
