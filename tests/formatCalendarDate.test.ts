...
import { formatCalendarDate } from '../src/index.js'
...
describe('formatCalendarDate', () => {
  ...
  it('should format date correctly for Europe/Berlin timezone (1)', () => {
    ...
    expect(result).toBe('2024-04-10') // 10th April 2024, 23:30 Berlin time
  })
  ...
  it('should format date correctly for Europe/Berlin timezone (2)', () => {
    ...
    expect(result).toBe('2024-04-11') // 11th April 2024, 01:00 Berlin time
  })
  ...
  it('should format date correctly for Australia/Sydney timezone (1)', () => {
    ...
    expect(result).toBe('2024-04-11') // 11th April 2024, 23:30 Sydney time
  })
  ...
  it('should format date correctly for Australia/Sydney timezone (2)', () => {
    ...
    expect(result).toBe('2024-04-12') // 12th April 2024, 00:00 Sydney time
  })
  ...
  it('should format date correctly with custom format string including time', () => {
    ...
    expect(result).toBe('2023-04-15 12:00:00')
  })
  ...
  it('should format date correctly with custom format string and timezone', () => {
    ...
    expect(result).toBe('2023-04-15 08:00:00')
  })
  ...
  it('should throw an error for invalid timezone', () => {
    expect(() => formatCalendarDate(testDate, { timezone: 'Invalid/Timezone' })).toThrow()
  })

  it('should throw an error for invalid locale', () => {
    expect(() => formatCalendarDate(testDate, { locale: 'some-invalid-locale' })).toThrow()
  })
})
