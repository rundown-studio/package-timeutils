...
import { moveAfter } from '../src/index.js'
...
describe('moveAfter', () => {
  ...
  it('should move the time to the next day when necessary', () => {
    ...
    const result = moveAfter(time, after)
    expect(result).toEqual(new Date('2023-05-16T23:00:00Z'))
  })
  ...
  it('should handle dates across month boundaries', () => {
    ...
    const result = moveAfter(time, after)
    expect(result).toEqual(new Date('2023-06-01T22:00:00Z'))
  })
  ...
  it('should handle leap years correctly', () => {
    ...
    const result = moveAfter(time, after)
    expect(result).toEqual(new Date('2024-02-29T23:00:00Z'))
  })
  ...
  it('should work correctly with different timezones America/New_York', () => {
    ...
    expect(result).toEqual(new Date('2023-05-15T06:00:00Z'))
  })
  ...
  it('should handle daylight saving time transitions America/New_York', () => {
    ...
    const result = moveAfter(time, after, { timezone })
    expect(result).toEqual(new Date('2023-03-12T08:30:00.000Z')) // Sun Mar 12 2023 04:30:00 GMT-0400 (Eastern Daylight Time)
  })
  ...
  it('should handle cases where "after" is many days later', () => {
    ...
    const result = moveAfter(time, after)
    expect(result).toEqual(new Date('2023-05-20T10:00:00Z'))
  })
  ...
  it('should handle DST transition in Europe/Berlin (Spring Forward)', () => {
    ...
    const result = moveAfter(time, after, { timezone })
    expect(result).toEqual(new Date('2023-03-26T18:30:00Z')) // Sun Mar 26 2023 20:30:00 GMT+0200 (Central European Summer Time)
  })
  ...
  it('should handle DST transition in Europe/Berlin (Fall Back)', () => {
    ...
    const result = moveAfter(time, after, { timezone })
    expect(result).toEqual(new Date('2023-10-30T01:30:00.000Z')) // Mon Oct 30 2023 02:30:00 GMT+0100 (Central European Standard Time)
  })
  ...
  it('should handle DST transition in Australia/Sydney (Spring Forward)', () => {
    ...
    const result = moveAfter(time, after, { timezone })
    expect(result).toEqual(new Date('2023-10-01T13:30:00Z')) // Mon Oct 02 2023 00:30:00 GMT+1100 (Australian Eastern Daylight Time)
  })
  ...
  it('should handle DST transition in Australia/Sydney (Fall Back)', () => {
    ...
    const result = moveAfter(time, after, { timezone })
    expect(result).toEqual(new Date('2023-04-02T15:30:00.000Z')) // Mon Apr 03 2023 01:30:00 GMT+1000 (Australian Eastern Standard Time)
  })
  ...
  it('should preserve time when moving across multiple days in Europe/Berlin', () => {
    ...
    const result = moveAfter(time, after, { timezone })
    expect(result).toEqual(new Date('2023-03-27T21:45:30Z'))
  ...
  it('should preserve time when moving across multiple days in Australia/Sydney', () => {
    ...
    const result = moveAfter(time, after, { timezone })
    expect(result).toEqual(new Date('2023-10-03T12:15:45.000Z')) // Tue Oct 03 2023 23:15:45 GMT+1100 (Australian Eastern Daylight Time)
  })
})
